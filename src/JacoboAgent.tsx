...
export default function JacoboAgent({ lang = 'en' }: { lang?: Lang }) {
  ...
  return (
    <ArticleLayout lang={lang}>
      <FloatingToc />
      <ArticleHeader editorId="hero-header" lang={lang} kicker={t.header.kicker} h1={t.header.h1} subtitle={t.header.subtitle} date={t.header.date} dateISO="2026-02-25" dateModifiedISO="2026-08-27" readingTime={t.readingTime} />
      ...
      <GitHubRepoBadge repo="santifer/jacobo-workflows" stars="165" forks="50" lang={lang} />
