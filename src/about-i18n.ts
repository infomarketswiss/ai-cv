...
export const aboutContent = {
  es: {
    ...
    seo: {
      ...
      description: 'Head of Applied AI. Creador de career-ops (72.6K+ ⭐ en GitHub). Construye sistemas IA en producción. Fundador de Santifer iRepair (30.000+ reparaciones, exit 2025).',
    },
    ...
    subtitle: 'Applied AI Operator · Founder · Builder of career-ops (72.6K+ ⭐)',
    ...
    projects: [
      ...
      { name: 'career-ops', desc: 'Sistema multi-agente de búsqueda de empleo: 740 evaluadas → 1 oferta', href: '/career-ops' },
    ...
    faq: [
      ...
      { q: '¿Qué ha construido Santiago?', a: 'Santiago ha construido cinco sistemas principales de IA en producción. Jacobo es un agente IA omnicanal que gestiona WhatsApp, voz (ElevenLabs) y llamadas telefónicas con sub-agentes especializados, logrando un 90% de autoservicio. El Self-Healing Chatbot es un sistema LLMOps con 71 evaluaciones automatizadas, defensa de jailbreak en 6 capas, RAG agéntico con Supabase pgvector, y un closed-loop que genera tests desde fallos reales en producción. career-ops es un sistema multi-agente de búsqueda de empleo con 740 ofertas evaluadas, evaluación multi-dimensional con un Global de 1,0 a 5,0 y generación de CVs ATS-optimized con Playwright y Puppeteer. El Business OS es un ERP custom con 12 bases de Airtable, 2.100 campos y más de 50 automatizaciones con n8n. El SEO Programático generó 4.730 páginas estáticas desde Airtable como headless CMS, logrando más de 2 millones de impresiones en Google.' },
  ...
  en: {
    ...
    seo: {
      title: 'Santiago Fernández de Valderrama | Head of Applied AI · Builder of career-ops',
      description: 'Head of Applied AI. Creator of career-ops (72.6K+ ⭐ on GitHub). Builds production AI systems. Founded Santifer iRepair (30,000+ repairs, exit 2025).',
    },
    heading: 'Santiago Fernández de Valderrama',
    ...
    bio: [
      ...
      'Builds production AI systems: career-ops (multi-agent job search system, 72.6K+ GitHub stars), a Self-Healing Chatbot with 71 automated evals and 6-layer jailbreak defense, the omnichannel AI agent Jacobo (n8n + ElevenLabs + tool calling, sold with the business), and a custom Business OS with 12 Airtable bases and 2,100 fields.',
      'Certified by Anthropic (Claude Code, MCP, AI Fluency, Teaching AI Fluency) and Airtable (Builder, Admin, AI App Builder). Teaching Fellow at Maven AI Product Academy (Dr. Marily Nika, Google).',
    ],
    seeking: '',
    roles: [],
    timelineHeading: 'Experience',
    timeline: [
      { period: '2026', role: 'Head of Applied AI', company: 'Zinkee', desc: 'Horizontal AI layer for B2B SaaS' },
    ...
    projects: [
      ...
      { name: 'career-ops', desc: 'Multi-agent job search system: 740 evaluated → 1 offer', href: '/career-ops-system' },
